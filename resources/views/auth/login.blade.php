...
<div class="w-full max-w-md bg-white rounded-xl shadow-lg border border-gray-200 p-8 mx-4 animate-fade-slide">
    ...
    <div class="text-center mb-6">
        ...
        <h1 class="text-2xl font-semibold text-black">Selamat Datang member!</h1>
        <p class="text-sm text-gray-500 mt-1">Silahkan masuk untuk melanjutkan Bugarin</p>
    </div>
    ...
    <p class="text-center text-sm text-gray-500 mt-2">
        Masuk sebagai admin?
        <a href="{{ route('login.admin') }}" class="text-indigo-600 hover:underline font-medium">Masuk</a>
</div>
@endsection
